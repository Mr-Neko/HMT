...
from models.pos3_visual.DSAattention import MultiHeadAttention
        ...
        for l in self.layers:
            if i % 3 == 0:  # layer4
                out = l(out, input[2], input[2],
                        relative_pos=None, attention_mask=attention_mask, attention_weights=attention_weights, pos=pos)
            elif i % 3 == 1:
                out = l(out, input[1], input[1],
                        relative_pos=None, attention_mask=attention_mask_4_layer3, attention_weights=attention_weights, pos=pos)
            elif i % 3 == 2:
                out = l(out, input[0], input[0],
                        relative_pos=None, attention_mask=attention_mask_4_layer2, attention_weights=attention_weights, pos=pos)
