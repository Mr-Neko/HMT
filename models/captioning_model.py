...
class CaptioningModel(Module):
    ...
    def step(self, t, prev_output, visual, seq, train, mode='teacher_forcing', **kwargs):
        raise NotImplementedError

    def forward(self, layer2, layer3, seq, *args):
        images = layer3 + layer2
    ...
    def beam_search(self, visual, max_len: int, eos_idx: int, beam_size: int, out_size=1,
