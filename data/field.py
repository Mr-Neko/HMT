...
class ImageGetField(RawField):
    def __init__(self, preprocessing=None, postprocessing=None, model_name=None, device=None):
        ...
        super(ImageGetField, self).__init__(preprocessing, postprocessing)
    ...
    def preprocess(self, x, avoid_precomp=False):
        try:
            x = self.transpose(Image.open(x))

        except KeyError:
            warnings.warn('Could not find detections for')
